...
def testing_ECO (seq, res_path, bSaveImage): #parameters
    hog_params = {}
    ...
    params["t_features"] = [
        ...
        'fparams': cnn_params},
        {'get_fhog': (lambda im, **fparam, **gparam: get_fhog(im, **fparam, **gparam)),
        'fparams': hog_params},
        {'get_colorspace': (lambda im, **fparam, **gparam: get_colorspace(im, **fparam, **gparam)),
        'fparams': grayscale_params},
        {'get_table_feature': (lambda im, **fparam, **gparam: get_table_feature(im, **fparam, **gparam)),
        'fparams': cn_params},
        {'get_table_feature': (lambda im, **fparam, **gparam: get_table_feature(im, **fparam, **gparam)),
        'fparams': ic_params}
    ]
